...
public class ProductDaoJdbcTemplateImpl implements IProductDao {
	...
	private final String SQL_INSERT = "insert into product(name,email) values(?, ?)";
	private final String SQL_UPDATE = "update product set name=?, email=? where id=?";
	...
	public boolean add(Product product) {
		// TODO Auto-generated method stub
		int n = this.jdbcTemplate.update(this.SQL_INSERT, new Object[] {product.getName(), student.getEmail()});
